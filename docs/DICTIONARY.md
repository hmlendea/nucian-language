...
|abeceu|noun|store|A retail establishment that sells goods or services, often used to describe a physical location or an online marketplace.|
...
|amaril|adjectival|yellow|Describes something that has a color resembling that of ripe lemons, egg yolks, or certain flowers such as daffodils or sunflowers. It denotes the presence of the color yellow.|
...
|brușă|noun|brush|A tool with bristles, fibers, or other filaments, used for cleaning, grooming, painting, or applying a substance.|
...
|căpșă|noun|strawberry|A sweet, red fruit that grows on a low-lying, flowering plant of the genus Fragaria. It is characterized by its bright red color, juicy texture, and sweet flavor with a hint of tartness.|
...
|elitră|noun|wing|A flat, thin, and typically extended surface that protrudes from the side of an object, such as an aircraft or a bird. Wings are primarily used for generating lift and enabling flight. In the context of birds, wings are also used for gliding, soaring, and maneuvering in the air.|
...
|farfă|noun|plate|A flat, usually round dish used for serving food.|
...
|fleçă|noun|arrow|A projectile with a pointed end, shot from a bow.|
|flocă|noun|wool|The soft, thick hair of sheep or certain other animals, used to make clothing or fabric.|
...
|fruză|noun|cutlet, chop|A thin slice of meat, typically taken from the loin or rib section of an animal such as beef, pork, lamb, or veal. It is often boneless and may be tenderized by pounding to achieve a uniform thickness.Origin: A spelling mistake|
...
|îrgă|noun|hate|An intense feeling of dislike, hostility, or aversion towards someone or something. It can manifest as strong negative emotions, resentment, or animosity. Hate is often driven by perceived injustices, conflicts, prejudices, or differences in beliefs, values, or identities.|
...
|land|noun|room|A space used for a particular purpose or activity, or a place where someone can be accommodated.|
...
|mașă|noun|machine|A device or apparatus consisting of interconnected parts designed to perform a specific task or function. It is typically powered by mechanical, electrical, hydraulic, or pneumatic means and can range from simple tools to complex systems.|
...
|nursă|noun|nurse|A healthcare professional who is trained and licensed to provide medical care and support to patients.|
...
|semeçă|noun|sunflower seed|The edible seeds harvested from the flower head of the sunflower plant (Helianthus annuus). They are small, flat, and oval-shaped with a black and white striped shell.|
...
|templată|noun|template|A preset format or pattern used as a guide for creating consistent and standardized documents, designs, or structures, allowing for easy replication or customization.|
